...
-- Folding: require treesitter available at runtime; safe fallback if not
...
vim.keymap.set("i", "jj", "<Esc>zz", { desc = "Quit to Normal mode" })
...
local setup_treesitter = function()
	...
	vim.api.nvim_create_autocmd("FileType", {
		group = group,
		callback = function(args)
			if vim.list_contains(treesitter.get_installed(), vim.treesitter) then
...
local function FloatingTerminal()
	...
	local shell = vim.env.SHELL or "pwsh.exe"
